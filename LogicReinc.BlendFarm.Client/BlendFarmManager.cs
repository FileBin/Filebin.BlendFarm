...
public class BlendFarmManager {
    ...
    /// </summary>
    public async Task<RenderTaskResult> Render(string file, RenderManagerSettings settings = null, Action<RenderSubTask, Image> onResultUpdated = null, Action<RenderSubTask, Image> onTileReceived = null) {
        if (CurrentTask != null)
        ...
        try {
            ...
            RenderTaskResult? result = await CurrentTask.Render();

             = (CurrentTask as IRenderTask)?.FinalImage;
